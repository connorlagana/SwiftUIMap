...
class DirectionsController: UIViewController, MKMapViewDelegate {
    ...
    let navBar = UIView(backgroundColor: #colorLiteral(red: 0.1948848367, green: 0.7962132096, blue: 0.9489386678, alpha: 1))
...
//        requestForDirections()
    ...
    class RouteStepCell: LBTAListCell<MKRoute.Step> {
        ...
        override var item: MKRoute.Step! {
            didSet {
                ...
                let distanceInMiles = item.distance * 0.00062137
        ...
        override func setupViews() {
            ...
            distanceLabel.font = .italicSystemFont(ofSize: 16)
    ...
    func mapView(_ mapView: MKMapView, rendererFor overlay: MKOverlay) -> MKOverlayRenderer {
        ...
        polylineRenderer.strokeColor = #colorLiteral(red: 0.1948848367, green: 0.7962132096, blue: 0.9489386678, alpha: 1)
